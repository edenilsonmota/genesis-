        ...
        {tab === "areas" ? (
          <div className="grid gap-6 lg:grid-cols-[360px_1fr]">
            <form
              ...
              onSubmit={submitArea}
            >
              <h1 className="font-display text-xl font-bold">Nova área</h1>
              ...
              <SearchableSelect
                ...
                value={
                  cities
                    ...
                    .map((city) => ({ id: city.id, label: city.name }))[0] ??
                  null
                }
                onChange={(option) =>
                  setAreaForm({
          ...
          <div className="grid gap-6 lg:grid-cols-[400px_1fr]">
            ...
            >
              <h1 className="font-display text-xl font-bold">Nova igreja</h1>
              <SearchableSelect
                label="Área"
              ...
              <label className="block text-sm font-semibold">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setChurchForm({ ...churchForm, number: e.target.value })
                  }
                  required
                />
              </label>
              <label className="block text-sm font-semibold">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setChurchForm({ ...churchForm, complement: e.target.value })
                  }
                />
              </label>
              ...
              <div className="divide-y">
                {churches.map((church) => (
                  <div className="py-3" key={church.id}>
                    ...
                    <p className="text-sm text-slate-500">
                      {church.area.name} · {church.street}, {church.number} —{" "}
                      {church.neighborhood}
                    </p>
                    <p className="mt-2 text-xs text-slate-400">
                      Usuários e cargos serão adicionados na próxima etapa.
                    </p>
                  </div>
                ))}
                {!churches.length && (
